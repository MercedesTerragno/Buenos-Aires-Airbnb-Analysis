...
(...): Jupyter notebook showcasing the thought process for the exploratory data analysis.
(...): Buenos Aires Airbnb data from February 2021.
...
The main findings can be found at the post available [here](link to post).
